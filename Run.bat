...
echo.
set /p VarQuestion2= Acceptez-vous la licence SysInternals ? [o]ui/[N]on :
echo.
set /p VarQuestion3= Executer Yara ? [o]ui/[N]on :
echo.
...
if %VarQuestion% NEQ o goto :SysInternals
...
:SysInternals
if %VarQuestion2% NEQ o goto :main
echo %date% %time% : Outils SysInternals
echo %date% %time% : Outils SysInternals >> .\logs\C0-FF-EE.log
...
echo %date% %time% : Etape 01 - Collecte d'informations Hardware
echo %date% %time% : Etape 01 - Collecte d'informations Hardware >> .\logs\C0-FF-EE.log
...
echo %date% %time% : Etape 02 - Collecte d'informations Systeme
echo %date% %time% : Etape 02 - Collecte d'informations Systeme >> .\logs\C0-FF-EE.log
...
schtasks /Query /V /FO list >> .\logs\Systeme\Services_1.txt 2> .\logs\debug.log
schtasks /Query /V /FO CSV >> .\logs\Systeme\Services_1.csv 2> .\logs\debug.log
sc.exe queryex >> .\logs\Systeme\Services_2.txt 2> .\logs\debug.log

echo %date% %time% : Etape 03 - Collecte du Registre
echo %date% %time% : Etape 03 - Collecte du Registre >> .\logs\C0-FF-EE.log
...
echo %date% %time% : Etape 05 - Collecte d'informations reseau
echo %date% %time% : Etape 05 - Collecte d'informations reseau >> .\logs\C0-FF-EE.log
...
if %VarQuestion3% NEQ o goto :fin
echo %date% %time% : Etape 06 - Recherche Yara
echo %date% %time% : Etape 06 - Recherche Yara >> .\logs\C0-FF-EE.log
